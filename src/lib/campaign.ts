...
export const BUDGET_SLICES: BudgetSlice[] = [
  {
    ...
    amount: 92_000_000,
    note: "Salaries and materials for the people actually teaching your kids.",
  ...
  },
  {
    ...
    amount: 38_000_000,
    note: "The support staff whose thin coverage is the single biggest driver of teacher burnout.",
  ...
  },
  {
    ...
    amount: 34_000_000,
    note: "Currently spent on a silo. The same dollars can fund individualized pathways district-wide.",
  ...
  },
  {
    ...
    amount: 31_000_000,
    note: "Contractually locked. Not a place to look for savings.",
  ...
  },
  {
    ...
    amount: 18_000_000,
    note: "Heat, light, roofs, custodial staff across 11 schools.",
  ...
  },
  {
    ...
    amount: 16_000_000,
    note: "Where the sorting decisions get made. This is the line that needs a public dashboard.",
